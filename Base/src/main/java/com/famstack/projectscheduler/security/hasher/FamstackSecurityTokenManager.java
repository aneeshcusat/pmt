...
public class FamstackSecurityTokenManager extends BaseFamstackService {
     ...
     */
    public static boolean validateSecurityToken(String clientCode, String encryptedString, String hashkey) {
        ...
        if (decryptedString != null) {
            ...
            if (timeDiff / 1000 <= 60 && decryptedClientId.equalsIgnoreCase(clientCode)) {
                return true;
            }
        }
        return false;
