...
<c:if test="${not empty usersList}">
    ...
    <tr style="padding-bottom: 0px;margin-top: 0px; border-bottom: 1px solid #dddddd">
        ...
        <span class="userdetails">
        	<img  style="width: 30px;border-radius: 20px;" alt="image" src="${applicationHome}/image/${user.id}"  onerror="this.src='${assets}/images/users/user-online.png'"></a>
        </span><b>${user.firstName}</b></td>
