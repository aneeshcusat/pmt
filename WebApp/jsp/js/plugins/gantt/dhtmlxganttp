...
! function(t, e) {
    ...
    return function(t) {
        ...
        l.prototype = {
            ...
            _attachLayers: function(t) {
                ...
                if (this.$config.bind) {
                    ...
                    for (var r = this.$config.layers, a = 0; r && a < r.length; a++) {
                        "string" == typeof(c = r[a]) && (c = this.$gantt.$ui.layers[c]), "function" == typeof c && (c = {
                            renderer: c
                        }), c.host = this;
                        var o = n.addLayer(c);
            ...
            _prepareScaleHtml: function(t, e, i) {
                ...
                var u = 0,
                    d = t.count;
                !n.smart_scales || isNaN(e) || isNaN(i) || (u = c(t.left, e), d = c(t.left, i) + 1), l = t.css || function() {}, !t.css && n.inherit_scale_class && (l = r.scale_cell_class);
        ...
        function r(t) {
            ...
            function a(n, r, a, o) {
                ...
                return e[s] ? e[s] : e[s] = function(e, n, r, a) {
                    ...
                    for (var o = r.unit, s = {}, l = 0; l < g.length; l++)
                        for (var c = g[l], u = t.date[o + "_start"](new Date(c.start_date)); u < c.end_date;) {
                            var d = u;
                            if (u = t.date.add(u, 1, o), t.isWorkTime({
                                    date: d,
                                    task: c,
                                    unit: o
                                })) {
            ...
            return t.$data.tasksStore.attachEvent("onStoreUpdated", function() {
                ...
                renderLine: function(t, e) {
                    for (var i = e.$getConfig(), n = e.$getTemplates(), r = a(t, i.resource_property, e.getScale(), e), o = [], s = 0; s < r.length; s++) {
                        var l = r[s],
                            c = n.resource_cell_class(l.start_date, l.end_date, t, l.tasks),
                            u = n.resource_cell_value(l.start_date, l.end_date, t, l.tasks);
                        if (c || u) {
                            var d = e.getItemPosition(t, l.start_date, l.end_date),
                    ...
                    var f = null;
                    if (o.length)
                        for (f = document.createElement("div"), s = 0; s < o.length; s++) f.appendChild(o[s]);
                    return f
                },
                renderHistogram: function(e, i) {
                    for (var n = i.$getConfig(), r = i.$getTemplates(), l = a(e, n.resource_property, i.getScale(), i), c = [], u = {}, d = e.capacity || i.$config.capacity || 24, h = 0; h < l.length; h++) {
                        var f = l[h],
                            _ = r.histogram_cell_class(f.start_date, f.end_date, e, f.tasks),
                        ...
                        if (u[f.start_date.valueOf()] = v || 0, _ || g) {
                            var m = i.getItemPosition(e, f.start_date, f.end_date),
                    ...
                    if (c.length) {
                        ...
                        var k = function(e, i, n) {
                            for (var r = i.getScale(), a = document.createElement("div"), l = 0; l < r.trace_x.length; l++) {
                                var c = r.trace_x[l],
                                    u = r.trace_x[l + 1] || t.date.add(c, r.step, r.unit),
                                    d = r.trace_x[l].valueOf(),
                                    h = Math.min(e[d] / n, 1) || 0;
                                if (h < 0) return null;
                                var f = Math.min(e[u.valueOf()] / n, 1) || 0,
                                    _ = o(h, c, u, i);
                                _ && a.appendChild(_);
        ...
        t.exports = function(t) {
            ...
            function g() {
                if (!d()) return f(!1), !1;
                var e = n.getNodePosition(t.$task || t.$grid || t.$root),
                    r = u.x - e.x,
                    a = u.y - e.y,
                    o = s ? 0 : p(r, e.width, c.x - e.x),
                    l = p(a, e.height, c.y - e.y),
                    h = t.getScrollState(),
                    _ = h.y,
                    g = h.inner_height,
                    v = h.height,
                        ...
                        this._legacyGridResizerClass(e), e.attachEvent("onBeforeResize", function() {
                            ...
                            if (a) {
                                ...
                                if (a.$config.hidden = a.$parent.$config.hidden = !o, !a.$config.hidden) {
                                    ...
                                    } else a.$parent._setContentSize(a.$config.width, a.$config.height), t.$layout._syncCellSizes(a.$parent.$config.group, t.config.grid_width);
        ...
        var n = i(1),
            r = function(t, e) {
                ...
                var c = e.$services,
                    u = c.getService("state"),
                    d = c.getService("dnd");
                u.registerProvider("linksDnD", l);
                var h = new d(t.$task_bars, {
                    sensitivity: 0,
                ...
                h.attachEvent("onBeforeDragStart", e.bind(function(i, r) {
                    ...
                    var d = !!n.locateClassName(s, "gantt_link_control"),
                        g = r,
                        v = i,
                        m = a,
                        y = e.locate(s),
                    ...
                    var S = !(v == d && g == y && m == b);
                    return S && (g && e.refreshTask(g, !1), y && e.refreshTask(y, !1)), S && _(c.marker),
                        function(i, n, r, a) {
                            var o = function() {
                ...
                return {
                    onCreated: function(e) {
                        e.$config = n.mixin(e.$config, {
                            bind: "task"
                        }), "grid" == e.$config.id && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = i(15)(t)
                    },
                    onInitialized: function(e) {
                        var i = e.$getConfig();
        ...
        t.exports = function(t) {
            return function(e, i) {
                ...
                for (var l = [], c = 0; c < r.length; c++) {
                    ...
                    var g = "gantt_cell" + (f ? " gantt_last_cell" : ""),
                        p = [];
                    if (_.tree) {
        ...
        t.exports = function(t) {
            return function(e, i) {
                ...
                var h = t.getGlobalTaskIndex(e.id) % 2 != 0,
                    f = r.task_row_class(e.start_date, e.end_date, e),
                ...
                createGroup: function(i, n, s) {
                    var l = {
                        ...
                        _add: function(t) {
                            ...
                            for (var i = this.container(), o = this.tempCollection, s = 0; s < o.length; s++)
                                if (t = o[s], this.container() || t && t.container && a.isChildOf(t.container, document.body)) {
                                    var l = t.container,
                                        c = t.id,
                                        u = t.topmost;
                                    if (!l.parentNode)
                                        if (u) i.appendChild(l);
                                        else {
                        ...
                        addLayer: function(t) {
                            return t && ("function" == typeof t && (t = {
                                renderer: t
                            }), void 0 === t.filter ? t.filter = o(s || []) : t.filter instanceof Array && (t.filter.push(s), t.filter = o(t.filter)), t.container || (t.container = document.createElement("div"))), this._add(t), t ? t.id : void 0
                        },
        ...
        i(19), t.exports = function() {
            var t = new function() {
                this.constants = i(156), this.version = "6.1.5", this.templates = {}, this.ext = {}, this.keys = {
        ...
        e.gantt = a, n.plugin(function(t) {}), e.default = a
    }])
});