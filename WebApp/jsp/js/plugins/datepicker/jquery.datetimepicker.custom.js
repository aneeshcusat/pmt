		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
				...
				month_picker = $('<div class="xdsoft_monthpicker"><button type="button" class="xdsoft_prev"></button>' +
					...
					'<button type="button" class="xdsoft_next"></button><button type="button" class="xdsoft_full_button"></button></div>'),
				...
				monthselect = $('<div class="xdsoft_select xdsoft_monthselect hide"><div></div></div>'),
				yearselect = $('<div class="xdsoft_select xdsoft_yearselect hide"><div></div></div>'),
